...
**58 requirements — 38 tested, 20 not unit-tested** (environment facts, browser-side UI, audio, and network fetch).
...
| **TRN-ARROW** | Color the review arrows by quality: a good move is green, a mistake is red. | — _not unit-tested_ |
