...
| **TRN-ARROW** | Colour the review arrows so the outcome is clear at a glance: the best move green — bright if you played it, dim if you missed it — your move black when it isn't the best, and any move you clicked to compare in grey. | — _not unit-tested_ |
